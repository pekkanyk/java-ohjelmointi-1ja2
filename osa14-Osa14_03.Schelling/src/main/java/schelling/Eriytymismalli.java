...
public class Eriytymismalli {
    ...
    public ArrayList<Piste> tyhjatPaikat() {
        ...
        for (int x=0;x<this.taulukko.getLeveys();x++){
            for (int y=0;y<this.taulukko.getKorkeus();y++){
                if (this.taulukko.hae(x, y)==0) tyhjat.add(new Piste(x,y));
            }
        }
        return tyhjat;
    }
    ...
    public ArrayList<Piste> haeTyytymattomat() {
        ...
        for (int x=0;x<this.taulukko.getLeveys();x++){
            for (int y=0;y<this.taulukko.getKorkeus();y++){
                int samanlaisia=0;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x-1, y-1)) samanlaisia++;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x, y-1)) samanlaisia++;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x+1, y-1)) samanlaisia++;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x, y-1)) samanlaisia++;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x, y+1)) samanlaisia++;
                if (this.taulukko.hae(x, y)==this.taulukko.hae(x-1, y+1)) samanlaisia++;
                ...
                if(samanlaisia<this.tyytyvaisyysraja) tyytymattomat.add(new Piste(x,y));
            }
        }
